...
export class FairServiceService {
  ...
  fairsArr :Array<Ifair>= [
    ...
    },
    {
      ...
      "fairName": "ISS iFair®️  (Central European Time)",
    ...
    },
    {
      ...
      "fairName": "ISS iFair®️ (Eastern Standard Time) ",
    ...
    },
    {
      ...
      "fairName": "ISS iFair®️ (China Standard Time) ",
  ...
  fecthAllFairs():Array<Ifair>{
    return this.fairsArr
  }

  fecthSingle(id:string):Observable<Ifair>{
    let fair:Ifair=this.fairsArr.find(fair=> fair.fairId===id) !
    return of(fair)
  }
}
